...
public:
	...
	void LoadFile(string fileName)
	{
		...
		int minOUTcarfailprob, maxOUTcarfailprob;
		...
		file >> minOUTcarfailprob >> maxOUTcarfailprob;
		minOUTfailprob = minOUTcarfailprob;
		maxOUTfailprob = maxOUTcarfailprob;
	...
	// Getters
	int getminOUTfailprob() { return minOUTfailprob; }
	int getmaxOUTfailprob() { return maxOUTfailprob; }
